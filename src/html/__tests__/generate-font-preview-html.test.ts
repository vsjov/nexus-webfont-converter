...
describe('Expect generateFontPreviewHtml', () => {
  ...
  describe('to call generateHtmlForDir for each font subdirectory', () => {
    it('when input directory contains font subdirectories', () => {
      ...
      expect(generateHtmlForDir).toHaveBeenCalledWith('/input/dm-sans', '/output/dm-sans', 'dm-sans')
      expect(generateHtmlForDir).toHaveBeenCalledWith('/input/roboto', '/output/roboto', 'roboto')
    })
  })
