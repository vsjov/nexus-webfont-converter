 ...
 */
export declare const generateScssForDir: (fontDir: string, outputFontDir: string, dirName: string, progress?: ProgressOptions) => void;
export default generateScssForDir;
//# sourceMappingURL=generate-scss-for-dir.d.ts.map