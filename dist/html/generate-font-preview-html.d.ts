 ...
 */
export declare const generateFontPreviewHtml: (inputDir: string, outputDir: string, progress?: ProgressOptions) => void;
export default generateFontPreviewHtml;
//# sourceMappingURL=generate-font-preview-html.d.ts.map