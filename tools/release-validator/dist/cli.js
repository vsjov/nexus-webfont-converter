 ...
 */
export const runReleaseValidatorCli = (args = process.argv.slice(2)) => {
    ...
    console.log(`Validated ${validation.tagName} at ${validation.tagCommit} on origin/release/${validation.version}`);
};
// Main
// -----------------------------------------------------------------------------
